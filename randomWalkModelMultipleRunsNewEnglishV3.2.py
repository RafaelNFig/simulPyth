...
for i in range(numberOfRuns):
    ...
    print(model.numberOfSicks())
    print(model.numberOfHealthys())
    print(model.numberOfImmunes())
    model.printImage(i)